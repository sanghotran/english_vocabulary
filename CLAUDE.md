...
This project is indexed by GitNexus as **english** (474 symbols, 872 relationships, 42 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/english/context` | Codebase overview, check index freshness |
| `gitnexus://repo/english/clusters` | All functional areas |
| `gitnexus://repo/english/processes` | All execution flows |
| `gitnexus://repo/english/process/{name}` | Step-by-step execution trace |
